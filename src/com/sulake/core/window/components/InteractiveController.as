package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected var var_935:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_443 = new Array();
         var_443[0] = MouseCursorType.const_317;
         var_443[1] = MouseCursorType.const_38;
         var_443[2] = MouseCursorType.const_317;
         var_443[3] = MouseCursorType.const_317;
         var_443[4] = MouseCursorType.const_38;
         var_443[5] = MouseCursorType.const_38;
         var_443[6] = MouseCursorType.const_317;
         if(var_327 == null)
         {
            var_327 = new Array();
            var_327[0] = WindowState.const_93;
            var_327[1] = WindowState.const_72;
            var_327[2] = WindowState.const_78;
            var_327[3] = WindowState.const_66;
            var_327[4] = WindowState.const_46;
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_1012,param1.toolTipDelay != const_1399));
         return param2;
      }
      ...
      {
         var_936 = param1 == null ? const_740 : param1;
      }
      ...
      public function set method_2(param1:uint) : void
      {
         var_2264 = param1;
      }
      
      public function get method_2() : uint
      {
         return var_2264;
      }
   }
