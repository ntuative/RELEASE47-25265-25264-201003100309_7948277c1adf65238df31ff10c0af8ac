package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1098:String = "content";
      
      private static const const_1097:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1599 == null)
         {
            var_1599 = findChildByTag(TabContextController.const_1098) as IWindowContainer;
         }
         return var_1599;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_933 == null)
         {
            var_933 = findChildByTag(TabContextController.const_1097) as ITabSelectorWindow;
            if(var_933 != null)
            {
      ...
      {
         return !!var_773 ? selector.iterator : null;
      }
