package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_747:String = "margin_top";
      
      private static const const_1038:String = "_HEADER";
      
      private static const const_744:String = "margin_right";
      
      private static const const_1039:String = "_SCALER";
      
      private static const const_1037:String = "_TITLE";
      
      private static const const_1036:String = "_CONTENT";
      
      private static const const_746:String = "margin_left";
      ...
      private var var_1139:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_746,_loc3_.left,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_747,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_744,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_745,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_209);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1139 == null)
         {
            var_1139 = findChildByTag(const_1038) as IHeaderWindow;
            if(!var_1139)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1037) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1039) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_256,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_22 == null)
         {
            var_22 = findChildByTag(const_1036) as IWindowContainer;
            if(!var_22)
            {
