package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_862:IItemListWindow;
      
      private var var_351:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_351)
         {
            var_351 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_351)
            {
               var_351.addEventListener(WindowEvent.const_257,scrollBarEventProc);
               var_351.addEventListener(WindowEvent.const_197,scrollBarEventProc);
            }
         }
         return var_351;
      }
      ...
      override public function dispose() : void
      {
         if(var_351)
         {
            var_351.removeEventListener(WindowEvent.const_257,scrollBarEventProc);
            var_351.removeEventListener(WindowEvent.const_197,scrollBarEventProc);
            var_351 = null;
         }
         if(var_862)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_197)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_862)
         {
            var_862 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_862;
      }
