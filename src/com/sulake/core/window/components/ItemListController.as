package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1026:String = "auto_arrange_items";
      ...
      protected var var_1098:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_89 = 0;
         var_67 = 0;
         _horizontal = param2 == WindowType.const_287;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_164 = var_755 || !testParamFlag(WindowParam.const_33);
         _container = _context.create("_CONTAINER","",WindowType.const_310,WindowStyle.const_311,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_45,containerEventHandler);
         _container.addEventListener(WindowEvent.const_415,containerEventHandler);
         _container.addEventListener(WindowEvent.const_318,containerEventHandler);
         _container.addEventListener(WindowEvent.const_432,containerEventHandler);
         resizeOnItemUpdate = var_1098;
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_415,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_318,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_432,containerEventHandler);
         super.dispose();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1026,var_751,PropertyStruct.const_59,var_751 != const_1395));
         _loc1_.push(new PropertyStruct(const_1025,var_527,PropertyStruct.const_59,var_527 != const_1396));
         _loc1_.push(new PropertyStruct(const_1023,var_1098,PropertyStruct.const_59,var_1098 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1023:
                  ...
                  break;
               case const_1026:
                  var_751 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      private function containerEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case WindowEvent.const_415:
               updateScrollAreaRegion();
               break;
            case WindowEvent.const_318:
               if(!var_1366)
               {
                  updateScrollAreaRegion();
               }
               break;
            case WindowEvent.const_432:
               updateScrollAreaRegion();
               break;
