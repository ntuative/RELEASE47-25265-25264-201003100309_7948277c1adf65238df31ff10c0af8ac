package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_985:uint = 256;
      ...
      public static const const_1543:uint = 128;
      
      public static const const_1458:uint = 64;
      
      public static const const_580:uint = 4;
      
      public static const const_1161:uint = 0;
      
      public static const const_1382:uint = 16;
      
      public static const const_544:uint = 1;
      
      public static const const_1187:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_618:Boolean;
      
      protected var var_1595:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1187:
               ...
               break;
            case GraphicContext.const_1382:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_580:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_985:
               break;
            case GraphicContext.const_1161:
               break;
            default:
         ...
         if(var_618)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1595,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1595,16777215);
                  }
                  var_373 += bitmap.width * bitmap.height * 4;
               }
