package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_322)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_322[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_321[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_440[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_321[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_322[param1] = _loc3_;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinLayout(var_440[_loc1_]).dispose();
            delete var_440[_loc1_];
         }
         var_440 = null;
         _layoutsByState = null;
         for(_loc1_ in var_321)
         {
            ISkinTemplate(var_321[_loc1_]).dispose();
            delete var_321[_loc1_];
         }
         var_321 = null;
         var_322 = null;
      }
