package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1123:uint = 8;
       
      
      private var var_523:Dictionary;
      
      private var var_2203:Dictionary;
      
      private var var_2204:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1565 = new Dictionary();
         var_2204 = new Dictionary();
         TypeCodeTable.fillTables(var_1565,var_2204);
         var_1327 = new Dictionary();
         var_2203 = new Dictionary();
         StateCodeTable.fillTables(var_1327,var_2203);
         var_523 = new Dictionary();
         var_523["skin"] = BitmapSkinRenderer;
         var_523["bitmap"] = BitmapDataRenderer;
         var_523["fill"] = FillSkinRenderer;
         var_523["text"] = TextSkinRenderer;
         var_523["shape"] = ShapeSkinRenderer;
         var_523["unknown"] = SkinRenderer;
         var_523["RoomWidgetBadgeImageUpdateEvent"] = NullSkinRenderer;
         if(var_374 == null)
         {
            var_374 = new Array();
            var_374.push(WindowState.const_66);
            var_374.push(WindowState.const_68);
            var_374.push(WindowState.const_92);
            var_374.push(WindowState.const_46);
            var_374.push(WindowState.const_78);
            var_374.push(WindowState.const_72);
            var_374.push(WindowState.const_93);
            var_374.push(WindowState.const_85);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1327)
         {
            _loc3_.push(var_1327[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1565[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_613[param1] = new Array(SkinContainer.const_1123);
         }
