package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1448:String = "_INCLUDE";
      
      public static const const_822:String = "_EXCLUDE";
      
      public static const const_1493:String = "_TEMP";
      
      private static const const_1056:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1057:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1101:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_929:Dictionary;
      
      protected var var_1369:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1370:Dictionary;
      
      protected var var_1102:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1102,var_1101);
         var_929 = new Dictionary();
         var_1370 = new Dictionary();
         ParamCodeTable.fillTables(var_929,var_1370);
         var_1369 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1057,"");
         return param1.replace(const_1056,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1102)
            {
               delete var_1102[_loc1_];
            }
            for(_loc1_ in var_1101)
            {
               delete var_1101[_loc1_];
            }
            for(_loc1_ in var_929)
            {
               delete var_929[_loc1_];
            }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_822) == -1)
                  {
