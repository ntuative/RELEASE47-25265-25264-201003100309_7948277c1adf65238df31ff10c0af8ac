package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_622:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_17)
         {
            var_17 = getGraphicContext(!testParamFlag(WindowParam.const_33));
         }
         ...
         if(param7 != null)
         {
            ...
            if(var_17)
            {
               _context.invalidate(this,var_7,WindowRedrawFlag.const_75);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_121,WindowParam.const_136);
         var _loc2_:* = !testParamFlag(WindowParam.const_114,WindowParam.const_151);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            {
               ...
               {
                  if(var_8.width < _loc3_.width && getParamFlag(WindowParam.const_33))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               ...
               {
                  if(var_8.height < _loc3_.height && getParamFlag(WindowParam.const_33))
                  {
                     _loc3_.y = 0;
                  }
                  else
      ...
      {
         var_755 = param1;
         var_623 = !!var_755 ? uint(var_623 | var_1379) : uint(var_623 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2041 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_551:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_927:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1294:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_819:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_476:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_635:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_220:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_81 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_400,this,null));
         }
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_927;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_544,var_7);
            var_17.visible = var_330;
         }
         return var_17;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_7,WindowRedrawFlag.const_1011);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_327,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_33) || var_17 != null;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_754);
      }
      
      public function set color(param1:uint) : void
      {
         var_1379 = param1 & 4278190080;
         var_623 = !!var_755 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_7,WindowRedrawFlag.const_75);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_734))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_965;
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_193:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_136))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_179,WindowParam.const_151))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_352:
                  _context.invalidate(this,var_7.union(var_56),WindowRedrawFlag.const_444);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1016,this,null));
                     if(var_8 != null)
                     {
               ...
               case WindowNotifyEvent.const_301:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_635,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_220,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_440:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_903);
                  break;
               case WindowNotifyEvent.const_400:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_369:
                  if(!(var_18 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_444);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_220:
                  ...
                  break;
               case WindowNotifyEvent.const_421:
                  var_8.getRegionProperties(null,var_307);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_327:
      ...
      {
         return var_622 != null ? var_622 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_754);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_301;
         update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_870,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         return !testParamFlag(WindowParam.const_33) ? getGraphicContext(true).fetchDrawBuffer() : (var_8 != null ? var_8.fetchDrawBuffer() : null);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_443)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_414)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_992,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_551,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_352,this,null));
            }
            if(_loc6_)
            {
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1344,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_164 && var_754 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1507,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1507,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_75);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1256,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_66,false);
         _loc1_.type = WindowNotifyEvent.const_1370;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_307 = var_8.rectangle.clone();
               var_56.x = var_7.x;
               var_56.y = var_7.y;
               var_56.width = var_7.width;
               var_56.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_391,this,var_8));
            }
            else
            {
               var_307.x = 0;
               ...
               var_307.width = 0;
               var_307.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_909,this,_loc2_));
            }
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_18 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_369,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_18,_context,var_7,null,var_622,properties,var_624.concat(),_id) as WindowController;
         _loc2_.var_754 = var_754;
         ...
         _loc2_.var_1379 = var_1379;
         _loc2_.var_1106 = var_1106;
         _loc2_.var_330 = var_330;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_433;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_754 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         if(var_36 == WindowState.const_430)
         {
            return true;
         }
         ...
         _loc1_.type = WindowNotifyEvent.const_819;
         update(this,_loc1_);
         dispose();
         return true;
      }
