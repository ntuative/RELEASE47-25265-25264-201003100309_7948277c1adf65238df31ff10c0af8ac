package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_831:String = "AssetLibraryReady";
      
      public static const const_1222:String = "AssetLibraryUnloaded";
      
      public static const const_368:String = "AssetLibraryLoaded";
      
      public static const const_1262:String = "AssetLibraryLoadError";
       
      
      private var var_492:XML;
      ...
      private var var_493:Boolean = true;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_415)
         {
            _loc4_ = AssetTypeDeclaration(var_415[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         var_305 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1222));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_492 = _loc2_.manifest.copy();
         var_346 = _loc2_.resource;
         if(var_493)
         {
            AssetLibrary.fetchLibraryContents(this,var_492,var_346);
         }
         var_305 = true;
         dispatchEvent(new Event(AssetLibrary.const_368));
         dispatchEvent(new Event(AssetLibrary.const_831));
         if(var_493)
         {
            var_16.dispose();
            var_16 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_414[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_32,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_44,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_858,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_862,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1019,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_816,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_414[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_415.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_415[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_415)
         {
            _loc3_ = AssetTypeDeclaration(var_415[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_492.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_414[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_415[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
