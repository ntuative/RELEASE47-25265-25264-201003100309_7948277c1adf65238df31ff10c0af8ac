package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_1035:uint = 1;
      
      private static const const_485:uint = 0;
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         var array:Array = var_247[event.type];
         if(array)
         {
            callbacks = [];
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1035) : uint(const_485);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_247)
            {
               _loc2_ = var_247[_loc1_] as Array;
               for each(_loc3_ in _loc2_)
               {
                  _loc3_.callback = null;
               }
               delete var_247[_loc1_];
            }
            var_247 = null;
