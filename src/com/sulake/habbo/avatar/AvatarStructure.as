package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2179:PartOffsetData;
      
      private var var_896:AvatarActionManager;
      ...
      private var var_2178:AvatarRenderManager;
      
      private var var_433:FigureData;
      ...
      private var var_1558:AvatarStructureDownloadSet;
      
      private var var_729:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_107 = param2;
         var_2285 = param3;
         var_433 = new FigureData();
         var_432 = new PartSetsData();
         _animationData = new AnimationData();
         var_1558 = new AvatarStructureDownloadSet();
         var_729 = new AnimationManager();
         var_728 = param4;
         var_2179 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_896.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_896.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_433.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_896.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_729.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_432.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_432.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1259[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_896.getDefaultActionType();
         var _loc7_:Array = var_432.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_729.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_433.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_433.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_432.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_432.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_728 + " ready to go!");
         if(var_728 == AvatarType.const_81)
         {
            var_432.getPartDefinition("ri").appendToFigure = true;
            var_432.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_728)
         {
            case AvatarType.const_81:
               ...
               var_1558.add(new AvatarStructureDownload(var_107,_loc5_,var_433));
               break;
            case AvatarType.PET:
         }
         var_1558.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_729.getAnimation(param1);
      }
      ...
      {
         var_896 = new AvatarActionManager(var_107,var_728);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_107.hasAsset("dance" + _loc1_))
         {
            ...
            var_729.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_433.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_433.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_896.sortActions(param1);
      }
   }
}
