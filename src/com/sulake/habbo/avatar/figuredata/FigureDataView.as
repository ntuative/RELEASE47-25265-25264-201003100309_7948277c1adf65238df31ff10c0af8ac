package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_454:IBitmapWrapperWindow;
      
      private var _window:IWindowContainer;
      
      private var var_1169:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1169 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_454 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_454.bitmap = new BitmapData(var_454.width,var_454.height,true,16777215);
         var_454.bitmap.copyPixels(var_1169,var_1169.rect,new Point(0,0 - 0 - 8));
         var_454.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
