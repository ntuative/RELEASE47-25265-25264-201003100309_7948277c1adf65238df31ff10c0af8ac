package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1383 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1613 = parseInt(_loc2_,16);
         var_1615 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1421 = _rgb >> 16 & 255;
         var_1420 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1540 = var_1421 / 255 * 1;
         var_1539 = var_1420 / 255 * 1;
         var_1538 = _b / 255 * 1;
         if(var_1383 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1540,var_1539,var_1538,_alphaMultiplier);
         var_940 = generatePaletteMapForGrayscale(var_1615,var_1613);
      }
      
      public function get reds() : Array
      {
         return var_940.getValue("reds") as Array;
      }
      ...
      {
         return var_940.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_940.getValue("greens") as Array;
      }
      ...
      {
         return var_940.getValue("alphas") as Array;
      }
