package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_595:AvatarEditorHandler;
      ...
      private function init() : void
      {
         ...
         if(!var_1290)
         {
            ...
            var_505["null"] = new FigureData(this);
            var_505["null"] = new FigureData(this);
            _loc1_ = var_505["null"];
            _loc2_ = var_505["null"];
            ...
            var_15 = new Map();
            var_15.add(AvatarEditorCategory.const_979,new GenericModel(this));
            var_15.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_15.add(AvatarEditorCategory.const_292,new TorsoModel(this));
            var_15.add(AvatarEditorCategory.const_1251,new LegsModel(this));
            var_15.add(AvatarEditorCategory.const_801,new WardrobeModel(this));
            var_1290 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_595 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1048 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1048 >= _loc14_.clubLevel))
               {
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1206)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc5_.isSelectable && _loc21_ && (_loc16_ || var_1048 >= _loc5_.clubLevel))
               {
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_15.getValue(AvatarEditorCategory.const_801);
      }
      ...
      {
         var_713 = var_540.getFigureData(AvatarType.const_81);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_233 == null)
            {
               var_233 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_233.addChild(_view.window);
               var_233.center();
               var_233.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_979);
         if(var_595 != null)
         {
            var_595.getWardrobe();
         }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1048 = param3;
         var _loc4_:FigureData = var_505[param2];
         if(_loc4_ == null)
         {
            return;
         }
