package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1751 = parseInt(param1.@precedence);
         var_1755 = String(param1.@activepartset);
         var_1758 = String(param1.@assetpartdefinition);
         var_1757 = String(param1.@lay);
         var_1244 = String(param1.@geometrytype);
         var_1753 = Boolean(parseInt(param1.@main));
         var_1754 = Boolean(parseInt(param1.@var_1302));
         var_1752 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_575.add(param1,new Map());
         }
         var _loc4_:Map = var_575.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_575.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
