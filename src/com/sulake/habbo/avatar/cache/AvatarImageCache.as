package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1421:int = 60000;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_669)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_412)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_71.getParts(param1,(var_893 as AvatarImage).getFigure(),_loc6_,var_1244,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_71.getCanvas(var_198,var_1244);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1150[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_944 || _loc32_ == AvatarAction.const_733) && (_loc6_ == AvatarBodyPartType.const_292 || _loc6_ == AvatarBodyPartType.const_1156 || _loc6_ == AvatarBodyPartType.const_1227) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_198 == AvatarScaleType.const_52)
            {
               _loc30_.x += 67;
            }
            else
