package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_614:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_915:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_741 = _window.findChildByName("mylooks") as IItemListWindow;
         var_614 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_915 = _window.findChildByName("selector") as IItemListWindow;
         var_1576 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_242,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_741.getListItemIndex(param2.parent));
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_615)
         {
            var_915.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_615 = [];
         while(true)
         {
            ...
            var_915.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_614.addListItem(_loc3_.view.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_741.removeListItemAt(0);
            }
            for each(_loc2_ in _model.myLooks)
            {
               var_741.addListItem(_loc2_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_915.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_916 * 8 + var_614.getListItemIndex(param2.parent);
