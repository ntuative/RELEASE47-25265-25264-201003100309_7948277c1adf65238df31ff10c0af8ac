package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_142,param2,param3);
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_168,param2,param3);
         var_34["null"] = new AvatarEditorGridView(param1,FigureData.const_153,param2,param3);
