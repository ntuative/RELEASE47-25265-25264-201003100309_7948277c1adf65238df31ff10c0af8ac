package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1426:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_258:ToolbarBarMenuAnimator;
      
      private var var_1427:Number = 5;
      
      private var var_256:Array;
      
      private var var_126:Number = 50;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_126 = _window.width;
         var_190 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_809,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1426 = _loc7_.toolbar.@min_group_margin;
         var_1427 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_256,param1,param2,_window,var_258);
         createGroupsFromXmlList(_loc9_,var_554,param1,param2,var_190,var_258);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_126,var_473,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_126;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_190.x = var_126 + var_1427;
               var_190.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_126;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_126;
               _window.y = 0;
               var_190.x = 0;
               var_190.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_126;
               _window.x = 0;
               _window.y = 0;
               var_190.x = 0;
               var_190.y = var_126 + var_1427;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_126;
               _window.x = 0;
               _window.y = _loc1_.height - var_126;
               var_190.x = 0;
               var_190.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1426,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1178) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1426,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1178) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_126);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_126)
         {
            return "RIGHT";
         }
         if(param2 <= var_126)
         ...
         if(param2 >= _loc3_.height - var_126)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_126,var_473);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_554.length)
         {
            _loc2_ = var_554[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_473);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_126,var_473);
         }
      }
