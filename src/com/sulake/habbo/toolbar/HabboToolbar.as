package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_880,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_158,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_170,onSetToolbarIconStateEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_499,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_923,onHideWindowEvent);
         var_36 = true;
