package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1061:Number = 90;
      
      private static const const_755:int = 50;
      
      private static const const_1062:Number = 25;
      
      private static const const_1069:int = 50;
      ...
      private var var_991:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_991 = param2;
         var_561 = new Timer(const_1062);
         var_561.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_476.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_476.splice(_loc3_,1);
            var_477.splice(_loc3_,1);
         }
         var_477.push(param1.name);
         var_476.push(param2);
         param1.addEventListener(WindowEvent.const_452,windowEventListener);
         param1.addEventListener(WindowEvent.const_197,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_476[var_477.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_991.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_297.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_297.splice(var_297.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_991.getIconLoc(param1.iconId);
      ...
      {
         return var_477[var_476.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_297[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_562[_loc3_] = new Array();
            }
            if(var_562[_loc3_].indexOf(param1) < 0)
            {
               var_562[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_755 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_755 || param1.desktop.height - param1.y < const_1069;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_477.length)
         {
            if(var_477[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_562[_loc3_].length)
                  {
                     repositionWindow(var_562[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
