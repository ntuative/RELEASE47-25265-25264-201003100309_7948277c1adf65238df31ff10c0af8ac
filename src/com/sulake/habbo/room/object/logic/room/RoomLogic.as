package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1583:int = 1500;
      
      private var var_1581:int = 255;
      
      private var var_1582:int = 255;
      
      private var var_1351:uint = 16777215;
      
      private var var_1089:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_593:
                  _loc2_.setString(RoomObjectVariableEnum.const_692,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_698:
                  _loc2_.setString(RoomObjectVariableEnum.const_683,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_569:
                  _loc2_.setString(RoomObjectVariableEnum.const_549,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_393:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_215)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_610:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_966,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_898,int(_loc5_.bgOnly));
            var_1351 = _color;
            var_1581 = var_1329;
            var_1089 = _loc11_;
            var_1582 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_895,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_632,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_76.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_101,0);
            }
            return;
         }
         _loc5_--;
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1252,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1332,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_101,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_152)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_149 || _loc13_ == RoomPlaneData.const_251)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_921)
         {
            ...
            else
            {
               ...
               _loc9_ = var_1351 & 255;
               _loc10_ = var_1089 >> 16 & 255;
               _loc11_ = var_1089 >> 8 & 255;
               _loc12_ = var_1089 & 255;
               _loc13_ = (_loc2_ - var_921) / var_1583;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1581 + (var_1582 - var_1581) * _loc13_;
               _color = _loc3_;
               var_1329 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_632,_loc3_);
         }
      }
   }
}
