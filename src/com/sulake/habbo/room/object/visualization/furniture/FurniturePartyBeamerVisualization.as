package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_785:int = 15;
      
      private static const const_1122:int = 2;
      
      private static const const_348:int = 2;
      
      private static const const_786:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1077[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1076[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1077 = new Array();
         var_1077.push(Math.random() * _loc2_ * 1.5);
         var_1077.push(Math.random() * _loc2_ * 1.5);
         var_1074 = new Array();
         var_1074.push(1);
         var_1074.push(-1);
         var_1075 = new Array();
         var_1075.push(const_1122);
         var_1075.push(const_1121);
         var_1076 = new Array();
         var_1076.push(getRandomAmplitudeFactor());
         var_1076.push(getRandomAmplitudeFactor());
      }
