package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1487:String = null;
      ...
      private var var_1150:Boolean = true;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1487 != null && var_1487.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2263,param1);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_936:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_890:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1716 != param1 || var_1719 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_545[_loc3_] = "";
               var_546[_loc3_] = false;
               _loc3_--;
            }
            var_1716 = param1;
            var_1719 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_1718 != param1 || var_1717 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2263 = _loc3_.getNumber(RoomObjectVariableEnum.const_210);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_229));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            var_1487 = _loc3_.getString(RoomObjectVariableEnum.const_281);
