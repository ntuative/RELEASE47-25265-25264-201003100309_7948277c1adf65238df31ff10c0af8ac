package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1422:int = 0;
      ...
      private const const_1624:int = 2;
      
      private var var_799:AvatarVisualizationData = null;
      ...
      {
         var_799 = param1 as AvatarVisualizationData;
         createSprites(const_1053);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_385.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_572);
         ...
         var _loc14_:Number = _loc8_ - var_1247;
         ...
         var _loc20_:Boolean = var_286 != _loc3_.getUpdateID() || var_207 != param1.scale || var_163 != _loc4_.getUpdateID();
         ...
         if(_loc20_ || _loc21_)
         {
            ...
            if(var_576 != _loc7_)
            {
               for each(_loc49_ in var_385.getKeys())
               {
                  var_385.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_799.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_385.remove(_loc5_);
               var_385.add(_loc5_,_loc6_);
               var_576 = _loc7_;
            }
            ...
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_270) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc6_.method_4();
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_270);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_617);
            _loc6_.appendAction(AvatarAction.const_519,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_480);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_52)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_290,AvatarAction.const_1316[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_810);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1018,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_829);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_984);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_837,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_624);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_736);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_955,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_864);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_976,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_463);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_420) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_639);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_469);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_873);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_672,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1624);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_1020))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_799.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_800.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_800)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_385 != null)
         {
            _loc1_ = var_385.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_385.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
