package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_770:String = "selection_arrow";
      ...
      private static const const_1104:String = const_349;
      ...
      private var var_426:Map = null;
      
      private var var_1053:IEventDispatcher = null;
      
      private var var_1296:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_514 = [];
         var_512 = [];
         var_2121 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2117 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_427 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_31:
                     if(var_514.indexOf(_loc4_) == -1)
                     {
                        var_514.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_30:
                     if(var_512.indexOf(_loc4_) == -1)
                     {
                        var_512.push(_loc4_);
                     }
                     break;
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_293,_loc4_);
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_426 != null)
         {
            _loc2_ = var_426.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_176 != null && var_176.hasWorldType(const_278 + param1))
         {
            return var_176.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_513.add(_loc10_,_loc11_);
                              if(var_514.indexOf(_loc14_) < 0)
                              {
                                 var_514.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_512.indexOf(_loc14_) < 0)
                              {
                                 var_512.push(_loc14_);
                              }
                           }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_599.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_349,const_493,ROOM_CONTENT,const_769,const_770];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2121.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_166 && _loc5_ != RoomObjectLogicEnum.const_122)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_513.getValue(param1) as String;
         return getObjectType(_loc2_);
      }
      
      public function getPlaceHolderType(param1:String) : String
      {
         if(var_514.indexOf(param1) >= 0)
         {
            return const_349;
         }
         if(var_512.indexOf(param1) >= 0)
         {
            return const_493;
         }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1145);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2117.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1296.add(_loc5_,_loc8_);
               var_176 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_293,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_2118)
         {
            ...
            if(var_1053 != null)
            {
               var_1053.dispatchEvent(new Event(const_720));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_176 != null)
         {
            return var_176.getWorldHeightScale(const_278 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1053 = param1;
            var_2122 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2120 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2119 = param2.getKey("public.room.dynamic.download.url","");
            var_2116 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_36 = const_771;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_428 != null)
         {
            ...
            var_428.add(param1,param2);
         }
         if(var_426 != null)
         {
            var_426.remove(param2);
            var_426.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_166 && _loc5_ != RoomObjectVisualizationEnum.const_122)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_387.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_278 + param1) == RoomObjectCategoryEnum.const_62)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1296.getValue(param1) != null)
         {
            var_176 = var_1296.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_368,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_176 != null)
         {
            return var_176.getWorldScale(const_278 + param1);
         }
         return 32;
      }
