package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_119:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1669 = new RoomThumbnailRenderer(param1);
         var_865 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_179,var_119.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_865.refreshTags(_loc1_,var_119.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1669.refreshThumbnail(_loc1_,var_119.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_179,var_119);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_179,!true ? getEventCtg(var_119.categoryId) : getRoomCtg(var_119.categoryId));
         refreshRoomDesc(var_179,var_119);
         refreshExtraCont();
         refreshInfo(var_179,"trading_allowed",var_119.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_205,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
