package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_496:IDropMenuWindow;
      
      private var var_2370:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_498;
         }
         if(param1 == 3)
         {
            return Tabs.const_597;
         }
         if(param1 == 4)
         {
      ...
      {
         var _loc1_:int = var_496 == null ? 0 : int(var_496.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_249,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_496 == null)
         {
            var_496 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_496.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
