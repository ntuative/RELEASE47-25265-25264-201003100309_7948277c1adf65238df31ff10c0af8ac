package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2354:Dictionary;
      ...
      private var var_770:ISessionDataManager;
      
      private var var_771:RoomCreateViewCtrl;
      
      private var var_1669:RoomThumbnailRenderer;
      
      private var var_194:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_538:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_435:Tabs;
      
      private var var_246:MainViewCtrl;
      
      private var var_1668:Array;
      
      private var var_1004:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_246 = new MainViewCtrl(this);
         var_538 = new RoomInfoViewCtrl(this);
         var_771 = new RoomCreateViewCtrl(this);
         var_1669 = new RoomThumbnailRenderer(this);
         var_1004 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_246.startSearch(Tabs.const_204,Tabs.const_306,param1);
         var_246.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_770)
         {
            var_770.release(new IIDSessionDataManager());
            var_770 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_161.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_770 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_246.startSearch(Tabs.const_249,Tabs.const_202);
         var_435.getTab(Tabs.const_249).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_246.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
