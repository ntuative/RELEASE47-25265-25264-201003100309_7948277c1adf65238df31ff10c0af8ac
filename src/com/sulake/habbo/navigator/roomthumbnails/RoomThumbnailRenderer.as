package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1126:int = -16;
      
      private static const const_787:int = 32;
      
      private static const const_1125:int = 8;
      
      public static const const_392:int = 10;
      
      private static const const_1124:int = 40;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1126,_loc4_.y + const_1124 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2219[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_907.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_907.getImage(ThumbnailEditorModel.const_54,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_787 + _loc3_,param2 * const_1125);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_392)
         {
            var_1082[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1082[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_392)
         {
            if(false)
            {
               refreshObj(param1,var_1082[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1334 == null)
         {
            var_1334 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1334,var_1334.rect,new Point(0,0),null,null,true);
      }
   }
}
