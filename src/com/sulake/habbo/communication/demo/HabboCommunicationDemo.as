package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_167:HabboHotelView;
      ...
      private var var_1835:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1437:ILogger;
      ...
      private var var_396:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_989)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_178);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_299:
               ...
               break;
            case DisconnectReasonEvent.const_1014:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1022:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_805:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1833)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_666 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_666);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_162);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1188,var_1834));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_396.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_396.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1835);
      ...
      {
         var_666 = _habboConfiguration.getKey("sso.ticket",null);
         var_1188 = _habboConfiguration.getKey("flash.client.url","");
         var_1834 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_167 == null)
         {
            var_167 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_666 != null)
         {
            var_69.mode = HabboConnectionType.const_362;
            var_69.initConnection(HabboConnectionType.const_241);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1437 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_668);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1835 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_69.mode)
         {
            case HabboConnectionType.const_362:
               _loc6_ = "";
               ...
               var_988 = _loc4_;
               var_167.loadBannerImage(_loc7_ + "?token=" + var_988,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1350:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1229:
               var_667 = generateRandomHexString(30);
               var_396 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_396.init(var_667);
               _loc8_ = var_396.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_167.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_988);
         ...
         var_396 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_396.init(_loc14_);
            _loc15_ = var_396.getPublicKey(10);
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_104,onRoomSessionEnded);
      }
