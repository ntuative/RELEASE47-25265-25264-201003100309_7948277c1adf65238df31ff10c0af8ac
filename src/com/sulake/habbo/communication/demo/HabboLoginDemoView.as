package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_505:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_332.shockwaveClientUrl = var_114.shockwaveClientUrl;
         var_332.ssoTicket = var_114.ticket;
         var_114.removeEventListener(SSOTicket.const_288,onParsedTicketSuccess);
         var_114.removeEventListener(SSOTicket.const_253,onParsedTicketFailure);
         var_114 = null;
         dispatchEvent(new Event(const_505));
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = var_332.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_419,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_96,windowEventProcessor);
         }
         else
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_114 = new SSOTicket(var_332.assets,_loc2_,_loc1_);
         var_114.addEventListener(SSOTicket.const_288,onParsedTicketSuccess);
         var_114.addEventListener(SSOTicket.const_253,onParsedTicketFailure);
      }
