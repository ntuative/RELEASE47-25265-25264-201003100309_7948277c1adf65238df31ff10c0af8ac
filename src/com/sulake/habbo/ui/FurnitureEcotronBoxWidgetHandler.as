package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_598,RoomWidgetEcotronBoxOpenMessage.const_613,RoomWidgetEcotronBoxOpenedMessage.const_1236];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_598:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_613:
