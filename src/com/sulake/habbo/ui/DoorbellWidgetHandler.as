package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_100:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_652,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_719];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_719:
      ...
      {
         return [RoomSessionDoorbellEvent.const_100,RoomSessionDoorbellEvent.const_127,RoomSessionDoorbellEvent.const_55];
      }
