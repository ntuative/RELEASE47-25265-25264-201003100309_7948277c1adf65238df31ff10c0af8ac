package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_818:IRoomWidgetFactory = null;
      ...
      private var var_329:ISessionDataManager = null;
      
      private var var_1863:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_293,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_418,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_661,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_671 = _roomEngine.loadRoomResources(var_41.roomResources);
            if(false)
            {
               var_1194 = false;
         ...
         {
            var_1195 = !var_263.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_41.roomId,var_41.roomCategory,var_262[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_friendList && false)
         {
            ...
            _friendList.events.removeEventListener(FriendRequestEvent.const_240,processEvent);
         }
         _friendList = null;
         var_169.dispose();
         var_169 = null;
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_293,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_418,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_661,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_19 = null;
         var_818 = null;
         ...
         if(var_194 && false)
         {
            ...
            var_194.events.removeEventListener(HabboToolbarEvent.const_56,onHabboToolbarEvent);
         }
         var_194 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1863);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_194 != null)
         {
            var_169.toolbarSize = var_194.size;
            var_169.toolbarOrientation = var_194.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         switch(_loc2_.type)
         {
            ...
            case WindowMouseEvent.const_51:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_274:
               _loc3_ = "null";
               break;
            default:
               return;
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_262[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_818.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_622:
               ...
               if(var_673 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_41.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_407)
                  {
                     var_673.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_477:
               ...
               break;
            case RoomEngineObjectEvent.const_674:
               if(true)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_129:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_846,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_41.roomId,var_41.roomCategory,RoomVariableEnum.const_667);
            _loc13_ = _roomEngine.getRoomNumberValue(var_41.roomId,var_41.roomCategory,RoomVariableEnum.const_696);
            _loc14_ = _roomEngine.getRoomNumberValue(var_41.roomId,var_41.roomCategory,RoomVariableEnum.const_703);
            _loc15_ = _roomEngine.getRoomNumberValue(var_41.roomId,var_41.roomCategory,RoomVariableEnum.const_707);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_274,canvasMouseHandler);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_281);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_431:
               ...
               var_168 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_323,WindowStyle.const_311,WindowParam.const_84) as IToolTipWindow;
      ...
      {
         if(var_671 == null || false)
         {
            return;
         }
         var _loc2_:int = var_671.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_19 != null && var_41 != null && var_1195 && var_1194)
         {
            var_19.startSession(var_41);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_237));
         }
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(_friendList)
         {
            ...
            _friendList.events.addEventListener(FriendRequestEvent.const_240,processEvent);
         }
      }
