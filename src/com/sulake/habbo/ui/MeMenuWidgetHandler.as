   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_880,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_564,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_441,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_564,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_180,onCreditBalance);
         }
         var_10 = _container.inventory;
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_892,onAvatarEffectsChanged);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_939,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_441,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_441:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_365));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_561);
         _loc1_.push(RoomWidgetDanceMessage.const_582);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_532);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_628);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_697);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_726);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_730);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_690);
         _loc1_.push(RoomWidgetStopEffectMessage.const_656);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1176);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_982);
         ...
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_926);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_650);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_644);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_560);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_642);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1224);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_631);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_508);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_704);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_557));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_644:
               ...
               break;
            case RoomWidgetWaveMessage.const_561:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_582:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_532:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_628:
               if(var_10 != null)
               {
                  _loc12_ = param1 as RoomWidgetSelectEffectMessage;
                  var_10.setEffectSelected(_loc12_.method_9);
               }
               break;
            case RoomWidgetSelectEffectMessage.const_697:
               if(var_10 != null)
               {
                  _loc13_ = param1 as RoomWidgetSelectEffectMessage;
                  var_10.setEffectDeselected(_loc13_.method_9);
               }
               break;
            case RoomWidgetOpenCatalogMessage.const_690:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_676)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_242,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_730:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_836:
                        _catalog.openCatalogPage(CatalogPageName.const_1336,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_905:
                        var_10.toggleInventoryPage(InventoryCategory.const_269);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1280:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_726:
            case RoomWidgetStopEffectMessage.const_656:
            ...
            case RoomWidgetNavigateToRoomMessage.const_982:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_650:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_654:
               ...
               if(var_194)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_562:
               ...
               if(var_194 && false)
               {
                  var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_382,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_605:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == HabboClubLevelEnum.const_76)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_373,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_896));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_373,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1166));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_678));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_560:
            ...
            case RoomWidgetGetSettingsMessage.const_642:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_326,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_631:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_326,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_508:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_326,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_704:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_592));
               }
               break;
            default:
