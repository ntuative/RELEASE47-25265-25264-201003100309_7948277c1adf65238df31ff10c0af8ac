package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_485:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_146];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_486 != null)
         {
            ...
            {
               _loc2_ = var_486.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_146:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_486.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_686.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_305:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_486.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_686.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_684,RoomWidgetChatSelectAvatarMessage.const_699];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_684:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_146,_container.roomSession,0,"Version 25265-25264-201003100240");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_699:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_485 == null)
            {
               ...
               var_487.y = 0;
               var_487.z = 0;
               var_485 = _loc4_.getScreenPoint(var_487);
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_485.x || _loc8_.y != var_485.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_485,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_296;
      }
