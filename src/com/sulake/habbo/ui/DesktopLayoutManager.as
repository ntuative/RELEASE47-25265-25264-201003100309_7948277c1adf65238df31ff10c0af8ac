package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1078:String = "room_view";
      
      private var var_53:IWindowContainer;
      
      private var var_674:int = 50;
      
      private var var_2305:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_53.getChildByTag(const_1078) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_53.findChildByTag(const_1078) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_674;
               _loc2_.width = var_53.desktop.width - var_674;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_674;
               _loc2_.height = var_53.desktop.height - var_674;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_53.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_53.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_318,trimContainer);
            }
            _loc5_++;
         }
      }
