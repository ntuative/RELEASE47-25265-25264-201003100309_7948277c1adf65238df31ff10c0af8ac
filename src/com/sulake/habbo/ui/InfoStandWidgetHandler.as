package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_574);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_940);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_946);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_305)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_407)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_868)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_624);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_213)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_208)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_618);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1148;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_945;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1153);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_618);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_117];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_316);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_531);
         _loc1_.push(RoomWidgetFurniActionMessage.const_548);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_706);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_530);
         _loc1_.push(RoomWidgetUserActionMessage.const_406);
         _loc1_.push(RoomWidgetUserActionMessage.const_586);
         _loc1_.push(RoomWidgetUserActionMessage.const_727);
         _loc1_.push(RoomWidgetUserActionMessage.const_1269);
         _loc1_.push(RoomWidgetPetCommandMessage.const_640);
         _loc1_.push(RoomWidgetPetCommandMessage.const_540);
         _loc1_.push(RoomWidgetUserActionMessage.const_679);
         _loc1_.push(RoomWidgetUserActionMessage.const_402);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_117:
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_406)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_316:
            ...
            case RoomWidgetUserActionMessage.const_584:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_922,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_727:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_531:
            ...
            case RoomWidgetRoomTagSearchMessage.const_706:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_530:
               ...
               break;
            case RoomWidgetUserActionMessage.const_406:
               _container.roomSession.kickBot(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_586:
