package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_772:uint = 11;
       
      
      private var var_235:LatencyTracker = null;
      ...
      private var var_890:LagWarningLogger = null;
      
      private var var_889:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_235 = new LatencyTracker();
         var_890 = new LagWarningLogger();
         var_1307 = new Array(const_772);
         var _loc4_:int = 0;
         while(_loc4_ < const_772)
         {
            var_1307[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1174,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1267,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_535,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1000,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_668:
               trackLoginStep(HabboLoginTrackingStep.const_1353,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_235 != null)
            {
               var_235.communication = _communication;
               var_235.connection = param1;
            }
            if(var_890 != null)
            {
               var_890.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_309:
      ...
      {
         var_161 = IHabboConfigurationManager(param2);
         if(var_161)
         {
            Component(var_161).events.addEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
            if(var_235 != null)
            {
               var_235.configuration = var_161;
            }
            if(var_234 != null)
            {
               var_234.configuration = var_161;
            }
            if(var_890 != null)
            {
               var_890.configure(var_161);
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_263.events.addEventListener(AdEvent.const_384,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1000,String(_loc2_.guestRoomId));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_668,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_688,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_60,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_410,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_355:
               var_890.warpingDetected();
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_889)
            {
               var_889.release(new IIDHabboWindowManager());
               var_889 = null;
            }
            if(var_263)
            {
            ...
            if(var_177)
            {
               if(true)
               {
                  ...
                  Component(var_177).events.removeEventListener(HabboFriendListTrackingEvent.const_309,onFriendlistTrackingEvent);
               }
            ...
            if(var_136)
            {
               if(true)
               {
                  var_136.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_136.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_136.release(new IIDHabboHelp());
               var_136 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_355,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_161)
         {
            Component(var_161).events.removeEventListener(HabboConfigurationEvent.const_169,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_95);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_95,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_136 = param2 as IHabboHelp;
         var_136.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_136.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         var_889 = IHabboWindowManager(param2);
         if(var_889)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1058 > -1 && _loc2_ < var_1058)
         {
            ++var_1542;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1542);
         }
         if(var_1058 > -1 && _loc2_ - var_1058 > 15000)
         {
            ++var_1541;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1541);
         }
         var_1058 = _loc2_;
         if(var_234 != null)
         {
      ...
      {
         if(var_161 != null && Boolean(var_161.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_355,onLagWarningEvent);
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_177).events.addEventListener(HabboFriendListTrackingEvent.const_309,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_161)
            {
               if(var_161.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_161.getKey("client.fatal.error.url");
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_95,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_688)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1246);
         }
         else if(param1.type == HabboHotelViewEvent.const_410)
         {
