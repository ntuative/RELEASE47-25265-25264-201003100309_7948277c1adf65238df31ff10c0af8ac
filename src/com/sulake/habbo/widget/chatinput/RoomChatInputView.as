package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_497:int = 16;
      
      private static const const_1137:int = 20;
      
      private static const const_350:int = 10;
      
      private static const const_1138:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1092 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2252 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2251 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_749 = new Timer(1000,1);
         var_749.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_925 = new Timer(5000,1);
         var_925.addEventListener(TimerEvent.TIMER_COMPLETE,method_11);
         createWindow();
         refreshView();
      }
      ...
      private function method_11(param1:TimerEvent) : void
      {
         var_526 = false;
         sendTypingMessage();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_154,onInputChanged);
         _window.addEventListener(WindowEvent.const_452,onWindowMoved);
         var_1363 = true;
         var_144 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2253 = _loc2_.width + const_497 + _loc6_.width + const_1137;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1138,_loc8_.width) + const_497);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1092 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_144 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_526);
