package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1616:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1128 != null && var_1128.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_768 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_768 += param1.height + const_1615;
            return fit(param1);
         }
         param1.offset(_offsetX,var_768);
         _offsetX += param1.width + const_1616;
         return true;
      }
