package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_385,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_408,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_376,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_483,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_385,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_408,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_376,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_483,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_64:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_408:
               if(!var_221)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_376:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_483:
               if(!var_221)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_385:
               if(!var_221)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_576,var_153);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_57,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1067,const_1066,2,2),null,0) as IWindowContainer;
