   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_779.width,var_779.height,true,0);
      ...
      {
         var _loc2_:int = var_376.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_376.numGridItems)
         {
            return;
         }
         select(var_376.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_779 = BitmapData(_loc3_.content);
