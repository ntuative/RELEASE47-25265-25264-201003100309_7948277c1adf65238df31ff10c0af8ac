package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_497:int = 6;
      
      private static const const_350:int = 10;
      
      private static const const_1128:Number = 18;
      
      private static const const_1429:Number = 10;
      
      private static const const_1430:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1088,var_1087,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1088,var_743,var_1087,_roomId,_roomCategory,param1);
      }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_96,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         if(var_206 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_437 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1086 != 0)
            {
               _loc30_ = uint(var_1086 >> 16 & 255);
               _loc31_ = uint(var_1086 >> 8 & 255);
               _loc32_ = uint(var_1086 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_350;
            }
            else
            {
               _loc19_.text = var_743 + ":";
               _loc19_.y += var_437;
               _loc19_.width = _loc19_.textWidth + const_350;
               _width += _loc19_.textWidth + const_350;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1343 == RoomWidgetChatUpdateEvent.const_275)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_743);
            }
            else if(var_1343 == RoomWidgetChatUpdateEvent.const_250)
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_437;
            _loc20_.width = _loc20_.textWidth + const_497;
            _width += _loc20_.textWidth + const_497;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_350 + _loc20_.textWidth + const_497;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1088,var_1087,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1088,var_1087,_roomId,_roomCategory,param1);
      }
