package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_635:MeMenuSettingsViewSlider;
      ...
      private var var_1399:BitmapData;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_508);
         }
      ...
      {
         var_634 = param1.volume;
         if(var_635 != null)
         {
            var_635.setValue(var_634);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            var_1399 = (_loc5_.content as BitmapData).clone();
         }
         ...
         var_635 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_642));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_634 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1400);
               }
               break;
            case "sounds_on":
               if(var_634 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1401);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1399);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1400);
