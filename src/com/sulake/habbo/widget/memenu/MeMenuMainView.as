      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_833);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_835));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_689);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_276);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_676));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_637);
               break;
            case "news":
               if(false && false)
               {
