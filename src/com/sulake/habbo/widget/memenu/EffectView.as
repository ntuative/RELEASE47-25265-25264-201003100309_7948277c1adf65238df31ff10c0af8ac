package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_776:IWindow;
      
      private var var_777:IWindow;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_777 = _window.findChildByName("effect_hilite");
            var_777.visible = false;
         }
         var_775 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_776 = _window.findChildByName("loader_bar");
         if(var_776 != null)
         {
            var_418 = var_776.width;
            var_173.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_775 != null)
         {
            var_775.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_775.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
