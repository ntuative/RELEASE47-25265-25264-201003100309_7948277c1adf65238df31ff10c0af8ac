package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_192 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1830 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_192);
      ...
      public function dispose() : void
      {
         if(var_329 != null)
         {
            var_329.events.removeEventListener(BadgeImageReadyEvent.const_120,onBadgeImageReady);
            var_329 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_665,var_1830);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_665,var_665));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_665,var_665));
         _localizations.registerParameter(param1,"level",var_1607.toString());
         _localizations.registerParameter(param1,"name",var_329.userName);
         _localizations.registerParameter(param1,"realname",var_329.realName);
      }
   }
}
