package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1040:String = "badges";
      
      private static const const_1041:String = "pet_inventory";
      
      private static const const_1046:String = "pixelbalance";
      
      private static const const_1045:String = "credits";
      
      private static const const_1044:String = "inventory";
      
      private static const const_1043:String = "friendlist";
      
      private static const const_1042:String = "selectfurni";
      
      private static const const_1047:String = "selectbadge";
      ...
      private var var_542:IHabboToolbar;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_377:HabboNotificationViewManager;
      ...
      private var var_637:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_781);
         }
         var _loc6_:Map = var_781["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1151);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_637 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_957)
         {
            return;
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1387);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1685)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_964);
            var_1685 = true;
      ...
      override public function dispose() : void
      {
         ...
         if(var_542)
         {
            var_542.release(new IIDHabboToolbar());
            var_542 = null;
         }
         if(_windowManager)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1041:
               if(var_10)
               {
                  var_10.toggleInventoryPage(InventoryCategory.const_140);
               }
               break;
            case const_1042:
               break;
      ...
      {
         if(param1 != null && this.var_377 != null)
         {
            var_377.replaceIcon(param1);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_964,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_540.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_899,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_177 || param2.type == WindowEvent.const_603)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_377.isSpaceAvailable() && false)
         {
            var_377.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_540.createPetImage(_loc2_.figure,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_329);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc15_ = var_329.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc15_ = var_329.getWallItemData(_loc14_.furniClassId);
               }
               _loc6_ = var_329.getProductData(_loc4_.localizationId);
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1334,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_540.createAvatarImage(param2,AvatarScaleType.const_52);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_201);
         }
      }
      ...
      {
         var_542 = IHabboToolbar(param2);
         var_542.events.addEventListener(HabboToolbarEvent.const_87,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_329.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_1013);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_1013);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 4057)
            {
               return FurniCategory.const_289;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_87)
         {
            ...
            var_377 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_781["styles"],var_781["view"],var_542);
            ...
            registerUpdateReceiver(var_377,1);
            registerUpdateReceiver(this,2);
            var_329.events.addEventListener(BadgeImageReadyEvent.const_120,onBadgeImage);
            var_542.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
