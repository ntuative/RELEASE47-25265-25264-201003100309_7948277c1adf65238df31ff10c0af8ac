package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_859:FriendRequests;
      
      private var var_1819:int;
      
      var var_15:FriendCategories;
      
      private var var_2035:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_858:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2035 = new FriendListLookAndFeel();
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_859.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_859.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_435.findTab(FriendListTab.const_86).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_859 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_15.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_15.addCategory(new FriendCategory(FriendCategory.const_912,getText("friendlist.friends")));
         var_15.addCategory(new FriendCategory(FriendCategory.const_370,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_498)
         {
            var_498 = new Timer(120000);
            var_498.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_498.start();
         }
         getBuddyRequests();
         registerListeners();
      ...
      override public function dispose() : void
      {
         ...
         {
            var_498.stop();
            var_498.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_498 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_121)
         {
            var_121.release(new IIDHabboMessenger());
            var_121 = null;
         }
         if(var_161)
         {
         ...
         if(var_858)
         {
            var_858.release(new IIDHabboNotifications());
            var_858 = null;
         }
         if(var_194)
         {
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_121 = param2 as IHabboMessenger;
      ...
      {
         var _loc1_:String = var_161.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_170,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_859.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_435.findTab(FriendListTab.const_86);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_843.createAvatarImage(param1,AvatarScaleType.const_99);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_859.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_435.findTab(FriendListTab.const_86);
      ...
      {
         var_858 = param2 as IHabboNotifications;
      ...
      {
         return var_161.getKey(param1,param1,param2);
      }
