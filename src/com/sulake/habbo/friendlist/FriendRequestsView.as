package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_322 && _loc4_.state != FriendRequest.const_333)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_322;
      ...
      {
         var_1470 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1469 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1469.procedure = onDismissAllButtonClick;
         var_1470.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_322 && _loc4_.state != FriendRequest.const_333)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_240,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_86,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         {
            _friendList.refreshIcon(_loc2_,"accept",true,method_10,param1.requestId);
            _friendList.refreshIcon(_loc2_,"reject",true,onDeclineButtonClick,param1.requestId);
         }
         else if(param1.state == FriendRequest.const_322)
         {
         ...
         else if(param1.state == FriendRequest.const_877)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1470,_loc1_);
         setEnabled(var_1469,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_322;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_240,param1));
         }
      }
   }
}
