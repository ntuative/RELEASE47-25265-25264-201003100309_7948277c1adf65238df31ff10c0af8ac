package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2088:IContainerButtonWindow;
      
      private var var_2085:IContainerButtonWindow;
      
      private var var_2086:IContainerButtonWindow;
      
      private var var_2087:IContainerButtonWindow;
      ...
      {
         var_2085 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2086 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2088 = initButton("room_invite",onInviteButtonClick,param1);
         var_2087 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_266)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_266 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2085,isEnableMinimailButton(_loc1_));
         setEnabled(var_2086,isEnableHomeButton(_loc1_));
         setEnabled(var_2088,isEnableInviteButton(_loc1_));
         setEnabled(var_2087,isEnableRemoveButton(_loc1_));
      }
