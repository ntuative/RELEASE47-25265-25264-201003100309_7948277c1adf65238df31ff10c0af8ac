package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_672:ITextFieldWindow;
      ...
      {
         var_672 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_672.procedure = onSearchInput;
         var_672.addEventListener(WindowKeyboardEvent.const_148,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_50.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_300,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_672.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
