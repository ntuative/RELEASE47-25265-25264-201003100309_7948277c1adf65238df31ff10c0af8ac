package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1475:IMessageComposer;
      ...
      {
         var_924 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_923 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         var_412 = new Timer(300,1);
         var_412.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_55 = IFrameWindow(_main.getXmlWindow("chatlog_frame"));
         var_50 = IItemListWindow(var_55.findChildByName("chatline_list"));
         var_55.procedure = onWindow;
         var _loc1_:IWindow = var_55.findChildByTag("close");
         _loc1_.procedure = onClose;
         _main.connection.send(var_1475);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_924.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_55,_main,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_45 || param2 != var_55)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_923.clone());
         _loc4_.color = var_1354[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_55,_main,_loc6_,param2.chatterId);
         }
