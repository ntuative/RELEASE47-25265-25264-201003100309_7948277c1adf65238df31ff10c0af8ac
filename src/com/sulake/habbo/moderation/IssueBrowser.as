package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1632:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1630:String = "picked_issues";
      ...
      private const const_1631:String = "my_issues";
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_230 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_230.numTabItems)
            {
               _loc5_ = var_230.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_230.selector.getSelectableByName("open_issues");
         var_230.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_344.view.width = var_230.container.width;
         var_344.view.height = var_230.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1631:
               if(var_1493 == null)
               {
                  var_1493 = new MyIssuesView(issueManager,this,var_230.container);
               }
               return var_1493;
            case const_1632:
               if(var_1492 == null)
               {
                  var_1492 = new OpenIssuesView(issueManager,this,var_230.container);
               }
               return var_1492;
            case const_1630:
               if(var_1494 == null)
               {
                  var_1494 = new PickedIssuesView(issueManager,this,var_230.container);
               }
               return var_1494;
            default:
               return null;
