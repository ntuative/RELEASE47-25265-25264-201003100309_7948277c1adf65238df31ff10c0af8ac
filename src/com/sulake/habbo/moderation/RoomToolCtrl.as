package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1060:ICheckBoxWindow;
      ...
      private var var_1059:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_701,_data.flatId),var_55,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_723.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1164,_loc2_,var_423.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1060.isSelected,var_1059.isSelected,var_723.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1295);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1306);
      }
      
      public function populate() : void
      {
         var_50 = IItemListWindow(var_55.findChildByName("list_cont"));
         ...
         var_723 = ICheckBoxWindow(var_55.findChildByName("kick_check"));
         var_1060 = ICheckBoxWindow(var_55.findChildByName("lock_check"));
         var_1059 = ICheckBoxWindow(var_55.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_405));
