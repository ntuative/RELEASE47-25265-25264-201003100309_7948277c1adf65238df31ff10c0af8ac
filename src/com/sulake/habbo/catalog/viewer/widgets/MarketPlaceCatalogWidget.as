package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1618:int = 40;
      ...
      private function updateList() : void
      {
         ...
         if(!var_452)
         {
            ...
            var_452 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_452)
         {
            return;
         ...
         if(!var_380)
         {
            var_380 = new Timer(25);
            var_380.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_782 = 0;
         populateList();
         var_380.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_543)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_452 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_452.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1409);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_379.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_380)
         {
            var_380.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_380 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_782 >= var_543.length)
            {
               return true;
            }
            addListItem(var_543.getWithIndex(var_782));
            ++var_782;
            _loc1_++;
         }
         return false;
      ...
      public function updateStats() : void
      {
         ...
         if(_loc8_)
         {
            if(_loc6_.available)
            {
               ...
               marketPlace.localization.registerParameter(_loc10_,"days",_loc1_.method_3.toString());
            }
            else
            {
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_154)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_379));
            _loc7_.selection = 0;
         }
      }
