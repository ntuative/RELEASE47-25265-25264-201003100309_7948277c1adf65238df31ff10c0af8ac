package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_589[var_1040] as Array;
      ...
      {
         var _loc2_:Offer = var_589[var_1040][var_2046];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_364 || _loc1_.pricingModel == Offer.const_353)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_80 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1039.indexOf(_loc5_) == -1)
                        {
                           var_1039.push(_loc5_);
                           var_589.push(new Array());
                        }
                        _loc6_ = var_1039.indexOf(_loc5_);
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_589)
         {
            if(var_2046 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2046] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1040 = var_930.getGridItemIndex(param1.view);
