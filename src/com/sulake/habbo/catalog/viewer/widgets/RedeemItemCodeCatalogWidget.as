package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1071 != null)
         {
            var_1071.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1072 != null)
         {
            var_1072.removeEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1071 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1071 != null)
         {
            var_1071.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1072 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1072 != null)
         {
            var_1072.addEventListener(WindowKeyboardEvent.const_148,windowKeyEventProcessor);
         }
      }
