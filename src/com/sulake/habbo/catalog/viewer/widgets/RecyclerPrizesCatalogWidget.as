package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_647[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_543 = new Map();
         var_647 = recycler.getPrizeTable();
         if(var_647 == null)
         {
            return;
         }
         ...
         var_1744 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_647[0].prizes.length > 0)
         {
            select(var_647[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1744) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1371) as IWindowContainer;
         param2.method_1(_loc3_);
         param1.view = _loc3_;
         param1.grid = this;
