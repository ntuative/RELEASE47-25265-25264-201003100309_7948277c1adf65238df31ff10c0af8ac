package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1185:IScrollbarWindow;
      
      protected var var_1371:XML;
      
      private var var_1186:BitmapData;
      
      private var var_1165:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1166.text = "${" + _loc3_.name + "}";
            var_1165.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1166.text = "${" + _loc2_.localizationId + "}";
            var_1165.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_456:
                  _loc4_ = var_1186.clone();
                  if(var_558 != null)
                  {
                     var_558.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_558,var_1185,var_1371);
                  }
                  break;
               ...
               case Offer.const_353:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        _loc4_ = new BitmapData(var_83.width,var_83.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.method_4();
                              _loc13_.appendAction(AvatarAction.const_290,AvatarAction.const_619);
                              _loc13_.appendAction(AvatarAction.const_672,_loc6_.productClassId);
      ...
      {
         var_1166 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1165 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1433 = new Point(var_83.x,var_83.y);
         var_558 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1185 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_558 == null)
         {
         ...
         var_1186 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_83);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_32,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_83 != null && true)
         {
            ...
            if(true)
            {
               var_83.bitmap = new BitmapData(var_83.width,var_83.height,true,16777215);
            }
            var_83.bitmap.fillRect(var_83.bitmap.rect,16777215);
            _loc4_ = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
            var_83.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_83.invalidate();
            var_83.x = var_1433.x;
            var_83.y = var_1433.y;
            if(param3 != null)
