package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_431 >= var_314.length)
         {
            return "";
         }
         var petColor:IPetColor = var_314[var_431] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_607[var_1557] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_431 = param1.index;
         if(var_431 < 0 || var_431 > var_314.length)
         {
            var_431 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_543.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_154,onTextWindowEvent);
         var_543 = new Map();
         ...
         var_895 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_314 = [];
         var_607 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_895);
               if(_loc11_)
               {
                  var_607 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_607.length)
         {
            _loc12_ = var_607[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_895,_loc12_.id),getRaceLocalizationKey(var_895,_loc12_.id)));
            _loc6_++;
         }
         var_543.add(var_895,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_951,onApproveNameResult);
         _loc5_ = var_543.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_543.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_431 >= 0 && var_431 < var_314.length)
         {
            _loc7_ = var_314[var_431] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_607[var_1557] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_895,_loc3_.id,_loc2_,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.method_4();
         _loc4_.appendAction(AvatarAction.const_290,AvatarAction.const_666);
