package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_185:Dictionary = new Dictionary();
      
      private static const const_756:Object = {"frontpage3":[7,8]};
      
      private static const const_1071:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      ...
      {
         const_185["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_185["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_185["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_185["collectibles"] = ["ctlg_collectibles_link"];
         const_185["club1"] = ["ctlg_text_5"];
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_563.length)
         {
            _loc2_ = String(var_563[param1]).replace("#","0x");
