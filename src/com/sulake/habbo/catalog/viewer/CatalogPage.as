package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1325:EventDispatcher;
      ...
      {
         return _localization.hasLinks(var_902);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1384) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1325;
            _loc2_.init();
         }
         var_1325.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1325.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_902);
      }
