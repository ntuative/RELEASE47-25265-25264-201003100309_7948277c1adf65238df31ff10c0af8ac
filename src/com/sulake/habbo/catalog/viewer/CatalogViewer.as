package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1394:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_537 != null)
         {
            if(var_537.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_537.window);
            var_537.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1394);
         var_537 = _loc5_;
      ...
      {
         return var_537.dispatchWidgetEvent(param1);
      }
