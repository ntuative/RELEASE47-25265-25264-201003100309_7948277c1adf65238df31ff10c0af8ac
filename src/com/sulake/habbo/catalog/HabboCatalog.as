package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_186:PurchaseConfirmationDialog;
      ...
      private var var_375:ICatalogNavigator;
      ...
      private var var_1670:GiftWrappingConfiguration;
      ...
      private var var_945:ClubGiftController;
      ...
      {
         return var_329.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_149.credits = _loc3_.balance;
         updatePurse();
         if(!var_1672 && var_448 != null)
         {
            var_448.playSound(HabboSoundTypesEnum.const_989);
         }
         var_1672 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_329.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_80)
         {
            _loc3_ = var_329.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_186.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               var_1132 = param1.session.isPrivateRoom;
               if(var_82 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_161.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_161.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1670 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_194.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_945.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_375 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_149.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_149.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_945 == null)
         {
            var_945 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_186 == null)
            {
               var_186 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_186.showOffer(this,param1,param2,param3,_loc7_);
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_375.buildCatalogIndex(_loc2_);
         if(var_946 != "")
         {
            var_375.openPage(var_946);
            var_946 = "";
         }
         else
         {
            var_375.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_177)
         {
            _loc3_ = var_161.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_291 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_291.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_149.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_149.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_149.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_149.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_291.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_149.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1671 && var_448 != null)
         {
            var_448.playSound(HabboSoundTypesEnum.const_999);
         }
         var_1671 = false;
      }
      ...
      private function onMarketplaceItemStats(param1:MarketplaceItemStatsEvent) : void
      {
         ...
         _loc3_.method_3 = _loc2_.method_3;
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_291.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_291.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_291 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_291.habboCatalog = this;
      }
