package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_753:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1439)
         {
            case RecyclerStatusMessageEvent.const_1284:
               var_259 = const_344;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_882:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1439 != RecyclerStatusMessageEvent.const_882;
      }
      
      private function get statusActive() : Boolean
      {
         return var_259 != const_753;
      }
      ...
      {
         return active && var_259 == const_344;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_957:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1170:
