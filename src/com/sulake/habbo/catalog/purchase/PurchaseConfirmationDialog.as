package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1415:uint = 4.294967295E9;
      
      private const const_1416:uint = 4.293848814E9;
      
      private var var_765:int;
      
      private const const_1613:uint = 4.291613146E9;
      ...
      private const const_1614:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_210.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_764;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_764,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1416) : uint(const_1415);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_537,var_78,var_942);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_210.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_764);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_534[var_184]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_535[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_537,var_78,var_942,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_154:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_1632 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in var_222)
               {
                  ...
                  if(_loc5_.length >= const_1614)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1632 = _loc3_.text;
               break;
            case WindowMouseEvent.const_51:
               showSuggestions(false);
               if(var_1119)
               ...
               break;
            case WindowKeyboardEvent.const_518:
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_203:
                  ...
                  break;
               case ProductTypeEnum.const_371:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1390 = _loc1_.stuffTypes;
            var_534 = _loc1_.boxTypes;
            var_535 = _loc1_.ribbonTypes;
            var_764 = var_1390[0];
            var_184 = var_534[0];
            _ribbonIndex = var_535[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_210.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_210 == null)
         {
            var_210 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_446 == null)
         {
            var_446 = createWindow("suggestion_list_item") as IWindowContainer;
            var_446.procedure = suggestionsEventHandler;
         }
         if(var_210 == null || var_446 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_210.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_446.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
