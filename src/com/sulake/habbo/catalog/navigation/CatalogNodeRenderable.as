package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1460:XML;
      ...
      private var var_1462:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1460 == null)
         {
            ...
            var_1460 = _loc4_.content as XML;
         }
         if(var_1461 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1462 == 4294967295)
            {
               var_1462 = _loc1_.color;
            }
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_32,onIconImageReady);
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1383;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1460) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_50 = navigator.catalog.windowManager.buildFromXML(var_1461) as IItemListWindow;
         if(var_50 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1212;
            }
         }
      }
