package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      {
         if(var_36 == RoomSessionEvent.const_328 && _connection != null)
         {
            var_36 = RoomSessionEvent.const_90;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1066 as IUserDataManager;
      }
