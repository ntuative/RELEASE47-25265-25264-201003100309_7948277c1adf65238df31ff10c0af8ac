package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1363:String = "normal_badge";
      ...
      private const const_1403:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1403,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1403 + param1;
         ...
         switch(param2)
         {
            case const_1363:
               if(var_161 != null)
               {
                  _loc5_ = var_161.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_830:
               if(var_161 != null)
               {
                  if(var_161 != null)
                  {
                     _loc5_ = var_161.getKey("group.badge.url");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.const_32,onBadgeImageReady);
         }
