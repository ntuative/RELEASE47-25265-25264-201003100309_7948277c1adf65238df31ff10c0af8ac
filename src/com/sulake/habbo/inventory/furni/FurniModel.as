package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1102:int = 100;
      
      public static const const_332:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_509 = new Timer(const_1102,1);
         var_509.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_12.getSubCategoryViewId() == InventorySubCategory.const_233;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_425.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_425.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_700)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_509 != null)
            {
               var_509.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_509.stop();
               var_509 = null;
            }
            if(var_133 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_284)
         {
         ...
         else if(param3 == FurniCategory.const_289)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_233:
               ...
               break;
            case InventorySubCategory.const_834:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_12.checkCategoryInitilization(InventoryCategory.const_465);
         ...
         if(param1 == InventoryCategory.const_74 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_332:
                  var_12.toggleInventoryPage(InventoryCategory.const_140);
            }
         }
      }
      ...
      {
         if(var_879 && param1.type == RoomEngineObjectEvent.const_206)
         {
            var_12.showView();
            var_879 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_324 || _loc3_.category == FurniCategory.const_284 || _loc3_.category == FurniCategory.const_289)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_425.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_425 = new Map();
         var_425.add(const_42,new Array());
         var_425.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
