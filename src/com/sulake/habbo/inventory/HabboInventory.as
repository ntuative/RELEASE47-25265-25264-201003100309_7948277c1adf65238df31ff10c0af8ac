package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_814:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_49.getValue(InventoryCategory.const_612));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_49.getValue(InventoryCategory.const_74));
      }
      ...
      {
         var_149.clubPeriods = param1;
         var_149.clubDays = param2;
         var_149.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_49.getValue(InventoryCategory.const_140));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_892));
      }
      ...
      {
         return AchievementsModel(var_49.getValue(InventoryCategory.const_321));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_233:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_813.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_813.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_49.getValue(InventorySubCategory.const_233));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_329 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_813.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_149.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_49.getValue(InventoryCategory.const_465) as MarketplaceModel;
      }
      ...
      {
         return var_149.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_149.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_49.getValue(InventoryCategory.const_269));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionEvent.const_104,roomSessionEventHandler);
         ...
         var_49.add(InventoryCategory.const_465,_loc3_);
         ...
         var_49.add(InventoryCategory.const_74,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_329);
         var_49.add(InventoryCategory.const_269,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_49.add(InventoryCategory.const_612,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_329);
         var_49.add(InventoryCategory.const_321,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_49.add(InventorySubCategory.const_233,_loc8_);
         ...
         var_49.add(InventoryCategory.const_140,_loc10_);
