package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1023:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_580 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_580.width;
         var_95 = var_580.height;
         var_1024 = param5;
         var_848 = param6;
         var_229 = Math.floor(var_1024 / _thumbWidth);
         var_20 = new BitmapData(var_1024,var_848);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_491 - 1)
         {
            ...
            var_20.fillRect(new Rectangle(0,0 - var_95,var_20.width,var_95),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_20.width,0 - var_95);
               _loc2_ = new Rectangle(0,0,var_20.width,0 - var_95);
               _loc11_.copyPixels(var_20,_loc2_,new Point(0,0),null,null,true);
               var_20 = _loc11_;
               --var_491;
            }
         }
         if(var_20.height < var_848)
         {
            _loc12_ = new BitmapData(var_20.width,var_848);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_580.width,var_580.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_580.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_580,var_580.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1023 != null)
         {
            _loc1_ = var_1023.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_491 = resolveRowCountFromList();
         if(var_491 == 0)
         {
            var_20 = new BitmapData(var_1024,var_848);
            return;
         }
         var_20 = new BitmapData(Math.max(var_229 * _thumbWidth,var_1024),Math.max(var_491 * var_95,var_848),true,16777215);
         var_20.fillRect(var_20.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_491)
         {
            _loc4_ = 0;
            while(_loc4_ < var_229)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_20.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_95),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_229 && var_20.height < _loc3_.y * var_95)
         {
            _loc2_ = new BitmapData(var_20.width,var_20.height + var_95);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_229 - 1),var_95);
         ...
         _loc2_.copyPixels(var_20,_loc4_,new Point(0,var_95),null,null,true);
         _loc4_ = new Rectangle(0,var_95,_thumbWidth * (var_229 - 1),0 - var_95);
         _loc2_.copyPixels(var_20,_loc4_,new Point(_thumbWidth,var_95),null,null,true);
         var_20 = _loc2_;
      }
