package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_140 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1176 && param1.type == RoomEngineObjectEvent.const_206)
         {
            var_12.showView();
            var_1176 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1176 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_305,_loc3_.figure);
            var_12.closeView();
            return;
         }
      ...
      {
         if(var_968.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
