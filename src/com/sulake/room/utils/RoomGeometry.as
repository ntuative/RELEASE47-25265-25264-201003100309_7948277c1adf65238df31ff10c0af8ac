package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_737:Number = 64;
      ...
      private var var_2343:Number = 500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1481 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_410 != param1 * var_1481)
         {
            var_410 = param1 * var_1481;
            ++var_77;
         }
      }
      ...
      {
         if(var_407 != param1 * var_1480)
         {
            var_407 = param1 * var_1480;
            ++var_77;
         }
      }
      ...
      {
         if(var_409 != param1 * var_1482)
         {
            var_409 = param1 * var_1482;
            ++var_77;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2344 || _loc3_ > var_2343)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_407,0 * var_409,0 * var_410);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_407,0 * var_409,0 * var_410);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_407,param2.y * var_409,param2.z * var_410);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_407,param3.y * var_409,param3.z * var_410);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_407,param4.y * var_409,param4.z * var_410);
