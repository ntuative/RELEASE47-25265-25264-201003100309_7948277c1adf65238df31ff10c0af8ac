package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_15:String = "client.init.swf.error";
      ...
      public static const const_9:String = "client.init.volter.loaded";
      
      private static const const_23:String = "testLocalConnection";
      
      public static const const_18:String = "error_data";
      
      public static const const_21:String = "flash_version";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_21] = Capabilities.version;
            _loc6_[const_10] = 0;
            _loc6_[const_14] = param1;
            _loc6_[const_8] = String(param2);
            if(param3 != null)
            {
               _loc6_[const_18] = String(param3.getStackTrace());
            }
